...
public class paris_3e_ruedesarchives extends AppWidgetProvider {
    ...
    public void onReceive(Context context, Intent intent)
    {
        ...
        {
            RemoteViews views = new RemoteViews(context.getPackageName(), R.layout.paris_3e_ruedesarchives);
