...
import com.candicelouw.plaquesdeparisno3.R;

public class paris_3e_ruedutemple extends AppWidgetProvider {
    public void onReceive(Context context, Intent intent)
    {
        ...
        {
            RemoteViews views = new RemoteViews(context.getPackageName(), R.layout.paris_3e_ruedutemple);
